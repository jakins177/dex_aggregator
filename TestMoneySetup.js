...
const parsedUSDTABI = JSON.parse(usdtAbi)
...
const usdtContract = new web3.eth.Contract(parsedUSDTABI,usdtAddress );

const wethContract = new web3.eth.Contract(parsedWETHABI,wethAddress );
...
async function run() {
   ...
   await printBalanceOfTokens(usdtContract)


   await transferTenThousandFromUberAccount(usdtContract)
   ...
   await printBalanceOfTokens(wethContract)


   await transferTenThousandFromUberAccount(wethContract)
...
async function transferTenThousandFromUberAccount(contract)
{

   await console.log("Transfering...." + await contract.methods.symbol().call())
    await contract.methods
   .transfer(recipientAddress, 10000)
   .send({from: unlockedAddress})

}

async function printBalanceOfTokens(contract)
{
